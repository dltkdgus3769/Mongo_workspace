...
// 2022년 이후 가입한 사용자 찾기
db.users.find({}, { joinedAt: 1 })
db.users.find({ joinedAt: { $gte: ISODate("2022-01-01T00:00:00Z") } }, { name: 1, joinedAt: 1 })
...
db.users.find({ orders: { $exists: true } }, { _id: 0, name: 1, orders: 1 })
// 3
//     최근 5개의 주문만 가져오기
...
db.users.find({ subscriptions: { $regex: "Technology" } })
// 8
//     생년월일이 1990년 이후인 사용자 찾기
db.users.find({ birthdate: { $gte: ISODate("1990-01-01T00:00:00Z") } }, { _id: 0, name: 1, birthdate: 1 })
// 9
//     특정 제품을 구매한 사용자 찾기
