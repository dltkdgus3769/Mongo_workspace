...
db.orders.aggregate([
    { $match: { orderDate: { $gte: ISODate('2024-01-01T00:00:00Z'), $lte: ISODate('2024-03-01T00:00:00Z') } } },
...
db.orders.aggregate([
    ...
    { $project: { userId: "$_Id", totalOrderAmount: 1 } }
])
...
db.locations.aggregate([
    {
        $geoNear: {
            near: { type: "Point", coordinates: [126.9784, 37.5665] }, //서울 타워
